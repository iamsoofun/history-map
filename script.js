...
function computeModelStatusPanel() {
    ...
    rows.push({ component: "D2 — Violent-Crime Factor", level: "yellow", status: "Research only", detail: "Only 6 of 51 US states covered — structurally excluded from the live Risk Score regardless of test results." });
...
function renderModelStatusPanel() {
    ...
    const icon = { green: "🟢", yellow: "🟡", orange: "🟠", gray: "⚪", locked: "🔒" };
